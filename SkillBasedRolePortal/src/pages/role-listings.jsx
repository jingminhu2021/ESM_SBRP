...
function RoleListings() {
    ...
    return (
        ...
        <span className="mr-3">
        {sessionStorage.getItem('sys_role') === 'hr' && <button className="btn btn-primary btn-lg" type="button" onClick={() => window.location.href = '/createSkill'}>+ Create</button>}
        </span>
        {sessionStorage.getItem('sys_role') === 'hr' && <button className="btn btn-danger btn-lg" type="button" onClick={() => window.location.href = '/deleteSkills'}>- Delete</button>}
        </div>
            ...
            {rolelisting.role_listing_desc !== null ? (
                ...
                <strong>Description:</strong> {rolelisting.role_listing_desc.length > 50
                    ...
                    : rolelisting.role_listing_desc}
                        ...
                        <p><strong>Skill Required:</strong> {rolelisting.skill_name}</p>
