...
function RoleListings() {
    ...
    if (sessionStorage.getItem('sys_role') != 'hr') {
        ...
        useEffect(() => {
            axios.get('http://localhost:5002/view_single_role_listing/' + role_listing_id, {
                headers: {
                    ...
                    <div className="container">
                        ...
                        <div className="row">
                            <div className="col-lg-8">
                                ...
                                <Link to={'/viewRoles'} className="btn btn-secondary btn-md mt-4">Return to Role Listings</Link>
                            </div>
                        </div>
                    </div>
                </section>
